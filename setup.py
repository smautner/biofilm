...
setup(
    ...
    packages=[packname, 'biofilm.util','biofilm.binsearch'],
    python_requires='>=3.8',
    scripts=[ ],
    ...
    install_requires=[
        'scikit-learn==0.24.2','ubergauss==0.0.36','lmz==0.1.11','dirtyopts==0.0.17','numpy=1.22.0', 'structout==0.1.36', 'auto-sklearn==0.14.2'
        ],
